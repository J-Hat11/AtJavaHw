...
import javax.swing.*;
 ...
 public class PartC {
    ...
    }//used internet for help on this problem...Specifically regadring the inside of the for loop and the variables with stars next to them
    public static void Rose(Graphics g){
        int Height=400;
        int Width=400;
        double scale = 150.0;
        int steps = 1000;
