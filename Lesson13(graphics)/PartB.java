...
public class PartB {
    ...
    public static void tilerows(Graphics g){
        int tileSize = 100;
        for (int row = 0; row<4; row++){
            for (int colmn = 0; colmn<4; colmn++){
                if ((row +colmn)%2==0) {
                 ...
                 g.fillRect(colmn * tileSize , row * tileSize, tileSize, tileSize); //Used web to find out how to fill colors of boxes, x val and y val
